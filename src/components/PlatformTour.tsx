    ...
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      <Card 
        ...
        className={cn(
          ...
          // Mobile styles - will be overridden by CSS for proper centering
          "w-[calc(100vw-2rem)] max-w-sm mx-4 rounded-lg",
          // Desktop styles  
          "md:w-full md:max-w-md md:mx-0 md:cursor-move md:max-h-none"
        )}
        style={{
          // Use the positioning set by the useEffect - CSS will override on mobile
          left: window.innerWidth >= 768 ? modalPosition.x : '50%',
          top: window.innerWidth >= 768 ? modalPosition.y : '50%',
