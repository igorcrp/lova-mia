...
export function PremiumUpgrade() {
  ...
  // Only show upgrade message if daily limit is reached
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <span className="font-semibold text-red-600 dark:text-red-400">Daily limit reached!</span> Upgrade to <span className="font-semibold text-blue-600 dark:text-blue-400">Premium</span> for unlimited daily queries
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              $39/month • Unlimited queries • Advanced analytics • Premium Processing (70% faster)...
            </p>
          </div>
          <Button
  ...
  // For free users who haven't reached the limit, don't show anything
  return null;
}
