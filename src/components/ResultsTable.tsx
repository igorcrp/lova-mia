        ...
        {paginatedResults.length === 0 ? (
          ...
          <div className="space-y-3 w-full">
            {paginatedResults.map((result) => (
              <div key={result.assetCode} className="bg-card border rounded-lg p-3 space-y-3 w-full min-w-0">
                <div className="flex items-center justify-between">
                ...
                <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 text-sm w-full">
