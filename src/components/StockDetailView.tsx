                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1.5 md:space-y-2">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs md:text-sm leading-[1.2rem] font-medium">${result.finalCapital.toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-xs md:text-sm leading-[1.2rem] text-muted-foreground">Total Profit</span>
                            <span className={`text-xs md:text-sm leading-[1.2rem] font-medium ${result.profit > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                              ${result.profit.toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-xs md:text-sm leading-[1.2rem] text-muted-foreground">Success Rate</span>
                            <span className="text-xs md:text-sm leading-[1.2rem] font-medium">{result.successRate.toFixed(2)}%</span>
                          </div>
                          <div className="flex justify-between items-center">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1.5 md:space-y-2">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs md:text-sm leading-[1.2rem] font-medium text-green-600 dark:text-green-400">{result.profits} ({result.profitPercentage.toFixed(2)}%)</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-xs md:text-sm leading-[1.2rem] text-muted-foreground">Losses</span>
                            <span className="text-xs md:text-sm leading-[1.2rem] font-medium text-red-600 dark:text-red-400">{result.losses} ({result.lossPercentage.toFixed(2)}%)</span>
                          </div>
                          <div className="flex justify-between items-center">
