    ...
    <div className="w-full">
      ...
      <div className="pb-4 mb-5 border-b flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg md:text-xl font-bold">{result.assetCode}</h2>
        </div>
      </div>
              ...
              <>
                <TabsContent value="overview" className="mt-0">
                  ...
                  <div className="bg-card border p-4 rounded-lg mb-6">
                    <h3 className="text-sm leading-[1.2rem] font-medium mb-4">
                      Performance Metrics
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                      {/* Coluna 1: Returns */}
                      <div className="space-y-3">
                        <h4 className="text-sm leading-[1.2rem] font-medium mb-2 border-b pb-2">
                          Returns
                        </h4>
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            <span className="text-sm leading-[1.2rem] text-muted-foreground">
                              Final Capital
                            </span>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span
                              className={`text-sm leading-[1.2rem] font-medium ${result.profit > 0 ? "text-green-600" : "text-red-600"}`}
                            >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm leading-[1.2rem] font-medium text-green-600">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm leading-[1.2rem] font-medium text-red-600">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm leading-[1.2rem] font-medium">
                              {(result.profits > 0
                                ? (result.profits * result.averageGain) /
                                  (result.losses * Math.abs(result.averageLoss))
                                : 0
                              ).toFixed(2)}
                            </span>
                          </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm leading-[1.2rem] font-medium">
                              {(
                                Math.sqrt(252 / result.tradingDays) *
                                Math.sqrt(
                                  result.tradeHistory.reduce(
                                    (sum, trade) => sum + Math.pow(trade.profitPercentage, 2),
                                    0
                                  ) / result.tradingDays
                                )
                              ).toFixed(2)}
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm leading-[1.2rem] font-medium">
                              {(
                                ((result.profit / params.initialCapital) * 100) /
                                result.maxDrawdown
                              ).toFixed(2)}
                            </span>
                          </div>
                    ...
                    <div className="mt-6 p-4 border-t">
                      ...
                      <p className="text-sm leading-[1.2rem]">
                        ...
                        {params.entryPercentage}% entry and {params.stopPercentage}% stop
                        parameters. The analysis covers {result.tradingDays} trading days with an
                        initial capital of ${params.initialCapital.toLocaleString()}.
                      </p>
                      <p className="mt-2 text-sm leading-[1.2rem]">
                        The strategy resulted in {result.trades} trades (
                        {result.tradePercentage.toFixed(2)}% of days), with {result.profits}{" "}
                        profitable trades and {result.losses} losing trades. Stop-loss was triggered
                        on {result.stops} occasions ({result.stopPercentage.toFixed(2)}% of trades).
                      </p>
                      <p className="mt-2 text-sm leading-[1.2rem]">
                        The final capital of ${result.finalCapital.toLocaleString()} represents a
                        {result.profit > 0 ? " profit" : " loss"} of $
                        {Math.abs(result.profit).toLocaleString()}. Average gain was $
                        {result.averageGain.toFixed(2)} and average loss was $
