    ...
    <div className="w-full flex flex-col gap-4 md:gap-6">
      ...
      <div className={`${isMobile ? 'space-y-4' : 'grid md:grid-cols-4 gap-4'}`}>
        ...
        <div className={`${isMobile ? 'order-1' : 'md:col-span-3'} bg-card rounded-lg border p-3 md:p-4`}>
          ...
          <div style={{ width: '100%', height: isMobile ? '250px' : `${chartHeight}px` }}>
        ...
        <div ref={setupPanelRef} className={`${isMobile ? 'order-2' : 'md:col-span-1'} bg-card rounded-lg border p-3 md:p-4`}>
