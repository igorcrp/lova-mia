            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={window.location.pathname === "/app"}>
                <NavLink 
                  ...
                  className="flex items-center gap-3 text-sidebar-foreground hover:bg-white/10 transition-colors"
                >
                  <Home size={18} />
                  {!isCollapsed && (
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={window.location.pathname === "/app/daytrade"}>
                  <NavLink 
                    to="/app/daytrade" 
                    onClick={handleMobileMenuClick}
                    className="flex items-center gap-3 px-2 text-sidebar-foreground hover:bg-white/10 transition-colors"
                  >
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <button 
                onClick={toggleTheme} 
                className="flex items-center gap-3 w-full text-sidebar-foreground hover:bg-white/10 transition-colors"
              >
