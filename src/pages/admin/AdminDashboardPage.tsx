  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Create a complete UserStats object with safe property access
        const completeUserStats: UserStats = {
          total: usersData.total || 0,
          active: usersData.active || 0,
          pending: usersData.pending || 0,
          inactive: usersData.total - usersData.active - usersData.pending || 0, // Calculate inactive
          premium: 0, // Default value since not provided by API
          new: 0 // Default value since not provided by API
        };
