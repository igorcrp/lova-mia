            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-1">
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className={`h-7 text-xs px-2 ${timeRange === "30" ? "bg-primary/10" : ""}`}
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className={`h-7 text-xs px-2 ${timeRange === "60" ? "bg-primary/10" : ""}`}
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className={`h-7 text-xs px-2 ${timeRange === "90" ? "bg-primary/10" : ""}`}
