              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                {indices.map((index, i) => (
                  <div 
                    ...
                    onClick={() => {
                      console.log(`Clicking on index: ${index.symbol}`);
                      handleIndexClick(index.symbol);
                    }}
                  >
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Click on an index above to see its top performing stocks (Selected: {selectedIndex})
            </p>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                ...
                {stocks.gainers.length > 0 ? (
                  ...
                  <div className="text-sm text-muted-foreground">Loading stocks data...</div>
                )}
              </div>
