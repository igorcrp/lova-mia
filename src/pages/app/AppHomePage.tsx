      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Click on an index to see the Top Performing Stocks below
          </p>
        </CardHeader>
        <CardContent>
          {error && (
      ...
      <Card>
        <CardHeader>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Highest gainers & biggest losers for {getSelectedIndexName()}
            </p>
          </div>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {stocks.gainers && stocks.gainers.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-5 gap-3">
